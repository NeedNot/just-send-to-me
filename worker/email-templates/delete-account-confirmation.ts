export function DeleteAccountConfirmation(days: number) {
  return `<!DOCTYPE html>
...
<body style="margin: 0; width: 100%; background-color: #060806; padding: 0; font-family: ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif; -webkit-font-smoothing: antialiased; word-break: break-word">
              ...
              <tr>
                <td class="sm-p-6" style="border-radius: 12px; background-color: #171717; padding: 24px 36px; border: 1px solid #282828">
                  ...
                  <p style="margin: 0 0 24px; font-size: 16px; line-height: 24px; color: #a1a1a1">
                    You have requested your account be permanently deleted. Your
                    account will be deleted if you don't sign in and restore your
                  ...
                  <p class="mso-break-all" style="margin-top: 32px; font-size: 12px; line-height: 20px; color: #a1a1a1">
                    If you want to proceed with account deletion you don't have to
                    do anything, just wait for the ${days} days.
                  </p>
                  <div role="separator" style="height: 1px; line-height: 1px; margin-top: 24px; margin-bottom: 24px; background-color: #282828">&zwj;</div>
                  <p class="mso-break-all" style="margin: 0; font-size: 12px; line-height: 20px; color: #a1a1a1">
                    If you did not request your account to be deleted you should cancel the deletion immediately and change your password. If you suspect this to be a scam you can go to the site directly <a href="https://justsendto.me">https://justsendto.me</a> or
                    <a href="mailto:support@justsendto.me">contacting support</a>
              ...
              <tr>
                <td class="sm-px-6" style="padding: 24px 36px">
                  <p style="margin: 0; font-size: 12px; color: #64748b">
                    &copy; 2025 JustSendToMe. All rights
                    reserved.
                  </p>
                </td>
              </tr>
