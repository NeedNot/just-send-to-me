            ...
            <table style="width: 100%" cellpadding="0" cellspacing="0" role="none">
              <tr>
                <td class="sm-p-6" style="border-radius: 12px; background-color: #171717; padding: 24px 36px; border: 1px solid #282828">
                  ...
                  <div role="separator" style="line-height: 24px">&zwj;</div>
                  <p style="margin: 0; font-size: 16px; line-height: 24px; color: #a1a1a1">
                    Thanks,
                    <br>
                    <span style="font-weight: 600; color: #fafafa">JustSendToMe</span>
                  </p>
                  ...
                  <p class="mso-break-all" style="margin: 0; font-size: 12px; line-height: 20px; color: #a1a1a1">
                    If you didn't sign up for an account on our website you can ignore this email or <a href="mailto:support@justsendto.me">contact support</a>
                  </p>
                </td>
              </tr>
            </table>
