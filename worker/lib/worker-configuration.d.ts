/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker/lib/worker-configuration.d.ts` (hash: 19cd264342797989391597ca8c8f461b)
// Runtime types generated with workerd@1.20260722.1 2025-10-14 nodejs_compat
interface __BaseEnv_Env {
	FILES_BUCKET: R2Bucket;
	DB: D1Database;
	FILE_DOWNLOAD_RATE_LIMITER: RateLimit;
	FILE_UPLOAD_RATE_LIMITER: RateLimit;
	GENERAL_RATE_LIMITER: RateLimit;
	IS_DEV: false | true;
	URL: "https://justsendto.me" | "http://localhost:5173";
	CLOUDFLARE_ACCOUNT_ID: "78382dff1e8ba1ce7ad866cb85aa5f39";
	R2_FILES_BUCKET: "files-bucket" | "dev-files-bucket";
	R2_ACCESS_KEY_ID: "e9282e37543da346d874cb675583d387" | "9d67e3c3e9db13fe86d67fe250d6f9c5";
	SMTP_SERVER_NAME: "smtp.zeptomail.com";
	SMTP_DOMAIN: "justsendto.me";
	SMTP_USERNAME: "emailapikey";
	GOOGLE_CLIENT_ID: "1087781101194-7lusmlc7f48eco6v9bmud3487lt6kj5u.apps.googleusercontent.com";
	...
	ADMIN_TOKEN: string;
	USER_CREDITS_OBJECT: DurableObjectNamespace<import("../index").UserCreditsObject>;
	FOLDER_UPLOADS_OBJECT: DurableObjectNamespace<import("../index").FolderUploadsObject>;
	DELETE_ACCOUNT_WORKFLOW: Workflow<Parameters<import("../index").DeleteAccountWorkflow['run']>[0]['payload']>;
	STRIPE_CHECKOUT?: KVNamespace;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../index");
		durableNamespaces: "FolderUploadsObject" | "UserCreditsObject";
	}
	interface ProductionEnv {
		...
		GENERAL_RATE_LIMITER: RateLimit;
		IS_DEV: false;
		URL: "https://justsendto.me";
		CLOUDFLARE_ACCOUNT_ID: "78382dff1e8ba1ce7ad866cb85aa5f39";
		R2_FILES_BUCKET: "files-bucket";
		R2_ACCESS_KEY_ID: "e9282e37543da346d874cb675583d387";
		SMTP_SERVER_NAME: "smtp.zeptomail.com";
		SMTP_DOMAIN: "justsendto.me";
		SMTP_USERNAME: "emailapikey";
		GOOGLE_CLIENT_ID: "1087781101194-7lusmlc7f48eco6v9bmud3487lt6kj5u.apps.googleusercontent.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IS_DEV" | "URL" | "CLOUDFLARE_ACCOUNT_ID" | "R2_FILES_BUCKET" | "R2_ACCESS_KEY_ID" | "SMTP_SERVER_NAME" | "SMTP_DOMAIN" | "SMTP_USERNAME" | "GOOGLE_CLIENT_ID" | "R2_SECRET_ACCESS_KEY" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_SECRET" | "SMTP_PASSWORD" | "TURNSTILE_SECRET_KEY" | "VITE_TURNSTILE_SITE_KEY" | "VITE_R2_URL" | "VITE_STRIPE_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ADMIN_TOKEN">> {}
}
