/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker/lib/worker-configuration.d.ts` (hash: e0f5c5129f5286eb367826db1d070d52)
...
declare namespace Cloudflare {
	...
	interface Env {
		PENDING_FILE_UPLOADS: KVNamespace;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SMTP_SERVER_NAME" | "SMTP_DOMAIN" | "SMTP_USERNAME" | "GOOGLE_CLIENT_ID" | "R2_ACCESS_KEY_ID" | "CLOUDFLARE_ACCOUNT_ID" | "R2_SECRET_ACCESS_KEY" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_SECRET" | "SMTP_PASSWORD" | "TURNSTILE_SECRET_KEY" | "VITE_TURNSTILE_SITE_KEY">> {}
}
